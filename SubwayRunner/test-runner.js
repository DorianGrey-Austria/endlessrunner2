...
class TestRunner {
    ...
    async gameLogicTest() {
        ...
        try {
            ...
            const hasLevelProgression = (content.includes('currentLevel * LEVEL_PROGRESSION_THRESHOLD') || content.includes('currentLevel * 1000')) && content.includes('nextLevelScore');
